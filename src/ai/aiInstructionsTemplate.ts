/**
 * Standard AI guidance template for generating markdown graphs compatible with Markdown Graph Studio.
 */
export const AI_GRAPH_INSTRUCTIONS_TEMPLATE = `# AI Guidelines for Generating Markdown Graphs (Markdown Graph Studio)
